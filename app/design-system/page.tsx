/**
 * Internal token system showcase — 1:1 mirror of the Borkd Design System
 * Figma file. NOT linked from the public site; reachable only by typing
 * /design-system into the URL bar. Used as a living reference when
...
export const metadata: Metadata = {
  title: "Borkd · Design System (internal)",
  description: "Token reference. Internal use only.",
